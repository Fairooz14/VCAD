...
This project can be deployed as a static export to GitHub Pages:
...
**Note:** GitHub Pages serves static files only. Dynamic Next.js features (API routes, server components, ISR) require a Node.js host like Vercel or Netlify.
